 ...
 */
namespace UMich_OIDC\Vendor\phpseclib3\Math\BigInteger\Engines\PHP;

use UMich_OIDC\Vendor\phpseclib3\Math\BigInteger\Engines\Engine;
use UMich_OIDC\Vendor\phpseclib3\Math\BigInteger\Engines\PHP;
use UMich_OIDC\Vendor\phpseclib3\Math\BigInteger\Engines\PHP\Reductions\PowerOfTwo;
/**
 * PHP Montgomery Modular Exponentiation Engine
 *
 * @author  Jim Wigginton <terrafrost@php.net>
