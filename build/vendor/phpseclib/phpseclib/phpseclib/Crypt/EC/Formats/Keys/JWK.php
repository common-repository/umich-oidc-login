 ...
 */
namespace UMich_OIDC\Vendor\phpseclib3\Crypt\EC\Formats\Keys;

use UMich_OIDC\Vendor\phpseclib3\Common\Functions\Strings;
use UMich_OIDC\Vendor\phpseclib3\Crypt\Common\Formats\Keys\JWK as Progenitor;
use UMich_OIDC\Vendor\phpseclib3\Crypt\EC\BaseCurves\Base as BaseCurve;
...
use UMich_OIDC\Vendor\phpseclib3\Crypt\EC\Curves\secp256k1;
use UMich_OIDC\Vendor\phpseclib3\Crypt\EC\Curves\secp256r1;
use UMich_OIDC\Vendor\phpseclib3\Crypt\EC\Curves\secp384r1;
use UMich_OIDC\Vendor\phpseclib3\Crypt\EC\Curves\secp521r1;
...
abstract class JWK extends Progenitor
{
    ...
    public static function load($key, $password = '')
    {
        ...
        $curve = '\\UMich_OIDC\\Vendor\\phpseclib3\\Crypt\\EC\\Curves\\' . \str_replace('P-', 'nistp', $key->crv);
        $curve = new $curve();
