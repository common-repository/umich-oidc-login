...
use UMich_OIDC\Vendor\phpseclib3\Crypt\Common\Formats\Keys\PKCS8 as Progenitor;
...
abstract class PKCS8 extends Progenitor
{
    ...
    public static function load($key, $password = '')
    {
        ...
        if (!$params) {
            throw new \RuntimeException('UMich_OIDC\\Vendor\\Unable to decode the parameters using Maps\\ECParameters');
        }
        $components = [];
