...
use UMich_OIDC\Vendor\phpseclib3\Crypt\EC\BaseCurves\Binary as BinaryCurve;
use UMich_OIDC\Vendor\phpseclib3\Crypt\EC\BaseCurves\Prime as PrimeCurve;
...
trait Common
{
    ...
    protected static function loadCurveByParam(array $params)
    {
        ...
        if (isset($params['namedCurve'])) {
            $curve = '\\UMich_OIDC\\Vendor\\phpseclib3\\Crypt\\EC\\Curves\\' . $params['namedCurve'];
    ...
    private static function encodeParameters(BaseCurve $curve, $returnArray = \false, array $options = [])
    {
        ...
        if ($useNamedCurves) {
            ...
            foreach (new \DirectoryIterator(__DIR__ . '/../../Curves/') as $file) {
                ...
                $class = 'UMich_OIDC\\Vendor\\phpseclib3\\Crypt\\EC\\Curves\\' . $testName;
