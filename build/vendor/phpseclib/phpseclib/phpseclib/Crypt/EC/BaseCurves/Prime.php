 ...
 */
namespace UMich_OIDC\Vendor\phpseclib3\Crypt\EC\BaseCurves;

use UMich_OIDC\Vendor\phpseclib3\Common\Functions\Strings;
use UMich_OIDC\Vendor\phpseclib3\Math\BigInteger;
use UMich_OIDC\Vendor\phpseclib3\Math\Common\FiniteField\Integer;
use UMich_OIDC\Vendor\phpseclib3\Math\PrimeField;
use UMich_OIDC\Vendor\phpseclib3\Math\PrimeField\Integer as PrimeInteger;
/**
 * Curves over y^2 = x^3 + a*x + b
 *
 * @author  Jim Wigginton <terrafrost@php.net>
    ...
    public function setBasePoint($x, $y)
    {
        switch (\true) {
            case !$x instanceof BigInteger && !$x instanceof PrimeInteger:
                throw new \UnexpectedValueException('UMich_OIDC\\Vendor\\Argument 1 passed to Prime::setBasePoint() must be an instance of either BigInteger or PrimeField\\Integer');
            case !$y instanceof BigInteger && !$y instanceof PrimeInteger:
                throw new \UnexpectedValueException('UMich_OIDC\\Vendor\\Argument 2 passed to Prime::setBasePoint() must be an instance of either BigInteger or PrimeField\\Integer');
        }
        if (!isset($this->factory)) {
            throw new \RuntimeException('setModulo needs to be called before this method');
        }
