 ...
 */
namespace UMich_OIDC\Vendor\phpseclib3\Crypt;

use UMich_OIDC\Vendor\phpseclib3\Crypt\Common\AsymmetricKey;
use UMich_OIDC\Vendor\phpseclib3\Crypt\EC\BaseCurves\Montgomery as MontgomeryCurve;
use UMich_OIDC\Vendor\phpseclib3\Crypt\EC\BaseCurves\TwistedEdwards as TwistedEdwardsCurve;
use UMich_OIDC\Vendor\phpseclib3\Crypt\EC\Curves\Curve25519;
use UMich_OIDC\Vendor\phpseclib3\Crypt\EC\Curves\Ed25519;
use UMich_OIDC\Vendor\phpseclib3\Crypt\EC\Curves\Ed448;
use UMich_OIDC\Vendor\phpseclib3\Crypt\EC\Formats\Keys\PKCS1;
use UMich_OIDC\Vendor\phpseclib3\Crypt\EC\Parameters;
use UMich_OIDC\Vendor\phpseclib3\Crypt\EC\PrivateKey;
use UMich_OIDC\Vendor\phpseclib3\Crypt\EC\PublicKey;
...
use UMich_OIDC\Vendor\phpseclib3\Exception\UnsupportedOperationException;
use UMich_OIDC\Vendor\phpseclib3\File\ASN1;
use UMich_OIDC\Vendor\phpseclib3\File\ASN1\Maps\ECParameters;
...
abstract class EC extends AsymmetricKey
{
    ...
    public static function createKey($curve)
    {
        ...
        $curve = '\\UMich_OIDC\\Vendor\\phpseclib3\\Crypt\\EC\\Curves\\' . $curveName;
