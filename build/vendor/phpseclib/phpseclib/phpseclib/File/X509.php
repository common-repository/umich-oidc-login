 ...
 */
namespace UMich_OIDC\Vendor\phpseclib3\File;
...
use UMich_OIDC\Vendor\phpseclib3\Crypt\PublicKeyLoader;
use UMich_OIDC\Vendor\phpseclib3\Crypt\Random;
use UMich_OIDC\Vendor\phpseclib3\Crypt\RSA;
use UMich_OIDC\Vendor\phpseclib3\Crypt\RSA\Formats\Keys\PSS;
use UMich_OIDC\Vendor\phpseclib3\Exception\UnsupportedAlgorithmException;
use UMich_OIDC\Vendor\phpseclib3\File\ASN1\Element;
use UMich_OIDC\Vendor\phpseclib3\File\ASN1\Maps;
...
class X509
{
    ...
    public function sign(X509 $issuer, X509 $subject)
    {
        ...
        if (isset($subject->domains) && \count($subject->domains)) {
            $altName = \array_map(['\\UMich_OIDC\\Vendor\\phpseclib3\\File\\X509', 'dnsName'], $subject->domains);
        }
