 ...
 */
namespace UMich_OIDC\Vendor\phpseclib3\Common\Functions;

use UMich_OIDC\Vendor\ParagonIE\ConstantTime\Base64;
use UMich_OIDC\Vendor\ParagonIE\ConstantTime\Base64UrlSafe;
use UMich_OIDC\Vendor\ParagonIE\ConstantTime\Hex;
use UMich_OIDC\Vendor\phpseclib3\Math\BigInteger;
use UMich_OIDC\Vendor\phpseclib3\Math\Common\FiniteField;
/**
 * Common String Functions
 *
 * @author  Jim Wigginton <terrafrost@php.net>
