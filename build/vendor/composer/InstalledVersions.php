 ...
 */
namespace UMich_OIDC\Vendor\Composer;

use UMich_OIDC\Vendor\Composer\Autoload\ClassLoader;
use UMich_OIDC\Vendor\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('UMich_OIDC\\Vendor\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
